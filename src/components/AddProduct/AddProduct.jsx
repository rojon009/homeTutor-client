        ...
        if (serviceDetails.imgFile) {
            ...
            axios.post('https://api.imgbb.com/1/upload', imageData)
                .then((response) => {
                    ...
                    if (imgUrl) {
                        axios.post(`https://hometutordb01.herokuapp.com/services/addService`, { name: serviceDetails.name, author: serviceDetails.author, price: serviceDetails.price, imgUrl })
                            .then(res => {
                                if(res.data) {
                                    setServiceDetails({
                                        name: '',
